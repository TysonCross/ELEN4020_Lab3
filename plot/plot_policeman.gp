...
# Titles
#set title "Top Word Frequency in 'The Third Policeman'" font ",18"
...
plot "../output/output_policeman.txt" using 1:xticlabels(2) with histogram linecolor rgb "#6BA5D5"
